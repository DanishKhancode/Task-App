...
class TaskList extends React.Component {
    handleTaskClick(taskDesc) {
        this.props.handleToCollectClickInfo(taskDesc);
    }
   render(){
        let list = [];
       ...
       return (
           <>
              ...
              <div className='task-lists'>
                <TaskList handleToCollectClickInfo={(taskDesc)=> this.handleTaskStatusUpdate(taskDesc , true)} tasks={todoTasks} purpose="Todo" forStyling="todo"/>
                <TaskList handleToCollectClickInfo={(taskDesc)=> this.handleTaskStatusUpdate(taskDesc ,false)} tasks={doneTasks} purpose="Finished" forStyling="finished"/>
              </div>
           </>
       );
    }
